...
def start_xvfb_display():
    ...
    if XVFB_DISPLAY is None:
        ...
        # Camoufox/BrowserForge needs a desktop-sized monitor to generate a
        # compatible Firefox fingerprint. The library default (800x680) is
        # too restrictive and can leave the fingerprint generator with no
        # valid candidates.
