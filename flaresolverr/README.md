...
This is the customized FlareSolverr source vendored for SBeans. Use the parent
`sbeans/docker-compose.yml` to build and run it; the upstream standalone Compose
file in this directory is retained for reference and is not part of the SBeans
deployment.
